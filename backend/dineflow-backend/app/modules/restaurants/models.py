...
class Restaurant(Base, TimestampMixin, SoftDeleteMixin):
    ...
    has_inventory: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    has_billing: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    enabled_modules: Mapped[Optional[Any]] = mapped_column(JSON, nullable=True)
